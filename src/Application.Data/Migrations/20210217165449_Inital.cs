    ...
    public partial class Inital : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilmQustions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFilmQuestions", x => new { x.UserId, x.QuestionId });
                    table.ForeignKey(
                        name: "FK_UserFilmQuestions_FilmQustions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "FilmQustions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFilmQuestions_Films_FilmId",
                        column: x => x.FilmId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Friendships", x => new { x.RequesterId, x.ResponderId });
                    table.ForeignKey(
                        name: "FK_Friendships_Users_BlockedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFilmQuestions_FilmId",
                table: "UserFilmQuestions",
                column: "FilmId");

            migrationBuilder.CreateIndex(
                name: "IX_UserFilmQuestions_QuestionId",
                table: "UserFilmQuestions",
                column: "QuestionId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_UserFilmQuestions_Users_UserId",
                table: "UserFilmQuestions",
                column: "UserId",
                principalTable: "Users",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Users_Images_CoverImageId",
                table: "Users",
                column: "CoverImageId",
                principalTable: "Images",
                principalColumn: "Id",
